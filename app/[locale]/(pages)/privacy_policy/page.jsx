...
export default async function page({ params: { locale }}) {
  ...
  return (
    <>
    <div className='mx-auto max-w-7xl px-2 py-6 sm:px-6 lg:px-8 flex flex-col gap-6'>
      <div className="">
        <h2 className='text-xl font-semibold mb-2'>{page.PrivacyPolicy.title}</h2>
        <p className='text-base'>{page.PrivacyPolicy.description}</p>
      </div>

      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.PersonalIdentificationInformation.title}</h2>
          <p className='text-base'>{page.PrivacyPolicy.PersonalIdentificationInformation.description}</p>
      </div>

      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.NonPersonalIdentificationInformation.title}</h2>
          <p className='text-base'>{page.PrivacyPolicy.NonPersonalIdentificationInformation.description}</p>
      </div>

      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.WebBrowserCookies.title}</h2>
          <p className='text-base'>{page.PrivacyPolicy.WebBrowserCookies.description}</p>
      </div>

      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.HowWeUseCollectedInformation.title}</h2>
      ...
      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.ProtectionOfInformation.title}</h2>
          <p className='text-base'>{page.PrivacyPolicy.ProtectionOfInformation.description}</p>
      </div>

      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.SharingPersonalInformation.title}</h2>
          <p className='text-base'>{page.PrivacyPolicy.SharingPersonalInformation.description}</p>
      </div>

      <div className="">
        <h2 className='text-lg font-semibold mb-2'>{page.PrivacyPolicy.ChangesTothisPrivacyPolicy.title}</h2>
