...
const SideItem = ({ id, title, description, imageUrl, createdAt, slug, lang }: Props) => {
  return (
    <li>
        ...
        <Image src={urlFor(imageUrl).url()} alt='' height="96" width="1000" className='w-100 object-fit-cover d-none d-md-block' ></Image>
        </Link>
        <div className="col-lg-8">
            ...
            <p className={`d-block d-md-none text-secondary-emphasis fs-7 ${styles.textTruncate2}`} style={{maxHeight: "40px"}}>{lang === "en" ? description.en : description.ar}</p>
